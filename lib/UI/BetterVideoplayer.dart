...
class BetterVideoPlayer extends StatefulWidget {
  ...
  double aspectratio;
  BetterVideoPlayer(
      {required this.url, required this.zoneid, required this.aspectratio});
  ...
  void load() {
    if (BETTERPLAYERCACHEOBJECTS[widget.zoneid] == null) {
      ...
      BetterPlayerDataSource betterPlayerDataSource =
          BetterPlayerDataSource(BetterPlayerDataSourceType.file, file);
      ...
      BETTERPLAYERCACHEOBJECTS[widget.zoneid]!
          .setupDataSource(BetterPlayerDataSource.file(file));
